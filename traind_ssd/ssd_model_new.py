...
def fpn(out1, out2, out3):
    ...
    out2 = keras.layers.Conv2D(256, 1, 2, "same")(out2)
    out2 = keras.layers.Conv2DTranspose(256, 1, 2, 'same')(out2)
    out1 = out1 + keras.layers.UpSampling2D(2)(out2)
    out1 = keras.layers.Conv2D(256, 1, 2, "same")(out1)
    out1 = keras.layers.Conv2DTranspose(256, 1, 2, 'same')(out1)
