...
def fpn(out1, out2, out3):
    ...
    out1 = keras.layers.Conv2D(256, 2, 1, "same")(out1)
    out1 = keras.layers.MaxPooling2D()(out1)
    out1 = keras.layers.Conv2D(256, 2, 2, "same")(out1)
    out1 = keras.layers.BatchNormalization()(out1)
    out1 = keras.layers.Conv2D(256, 2, 2, "same")(out1)
    out1 = keras.layers.MaxPooling2D()(out1)
    out1 = keras.layers.Conv2D(512, 3, 2, "same")(out1)
    out1 = keras.layers.BatchNormalization()(out1)
    out1 = keras.layers.UpSampling2D(2)(out1)
    out1 = keras.layers.Conv2D(512, 3, 3, "same")(out1)
    out1 = keras.layers.BatchNormalization()(out1)
    out1 = keras.layers.UpSampling2D(2)(out1)
    out1 = keras.layers.Conv2D(512, 4, 3, "same")(out1)
    out1 = keras.layers.BatchNormalization()(out1)
    ...
    out2 = keras.layers.Conv2D(512, 3, 3, "same")(out2)
    out2 = keras.layers.BatchNormalization()(out2)
    out2 = keras.layers.UpSampling2D(2)(out2)
    out2 = keras.layers.Conv2D(512, 4, 3, "same")(out2)
    out2 = keras.layers.BatchNormalization()(out2)
    ...
    out3 = keras.layers.Conv2D(512, 3, 3, "same")(out3)
    out3 = keras.layers.BatchNormalization()(out3)
    out3 = keras.layers.UpSampling2D(2)(out3)
    out3 = keras.layers.Conv2D(512, 4, 3, "same")(out3)
    out3 = keras.layers.BatchNormalization()(out3)
   
    out1 = keras.layers.Conv2D(1024, 4, 4, "same")(out1)
    out2 = keras.layers.Conv2D(1024, 4, 4, "same")(out2)
    out3 = keras.layers.Conv2D(1024, 4, 4, "same")(out3)
    ...
    out2 = keras.layers.Conv2D(256, 2, 1, "same")(out2)
    out2 = keras.layers.MaxPooling2D()(out2)
    out2 = keras.layers.Conv2D(512, 2, 1, "same")(out2)
    out2 = keras.layers.BatchNormalization()(out2)
    out2 = keras.layers.UpSampling2D(2)(out2)
...
def head(x, output_filters, out_name):
    ...
    for _ in range(4):
        x = keras.layers.SeparableConv2D(128, 3, padding="same", kernel_initializer='he_normal')(x)
    x = keras.layers.Conv2D(output_filters, 3, 1, padding="same", kernel_initializer='he_normal', name=out_name)(x)
...
def build_model(image_size,
    ...
    out1, out2, out3 = fpn(out1, out2, out3)

    classes1 = head(out1, n_boxes[0] * n_classes, out_name='classes1')
    classes2 = head(out2, n_boxes[0] * n_classes, out_name='classes2')
    classes3 = head(out3, n_boxes[0] * n_classes, out_name='classes3')

    boxes1 = head(out1, n_boxes[0] * 4, out_name='boxes1')
    boxes2 = head(out2, n_boxes[0] * 4, out_name='boxes2')
    boxes3 = head(out3, n_boxes[0] * 4, out_name='boxes3')
