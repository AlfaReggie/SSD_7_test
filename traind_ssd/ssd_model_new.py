...
def fpn(out1, out2, out3):
    ...
    out2 = keras.layers.Conv2DTranspose(64, 2, 2, 'same')(out2)
    ...
    out1 = keras.layers.Conv2DTranspose(64, 2, 2, 'same')(out1)
    out1 = keras.layers.Conv2D(128, 3, 3, "same")(out1)
    out2 = keras.layers.Conv2D(128, 3, 3, "same")(out2)
    out3 = keras.layers.Conv2D(128, 3, 3, "same")(out3)
