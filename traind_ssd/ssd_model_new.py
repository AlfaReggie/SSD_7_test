...
def fpn(out1, out2, out3):
    ...
    out3 = keras.layers.MaxPooling2D()(out3)
    out3 = keras.layers.Conv2D(512, 2, 1, "same")(out3)
    out3 = keras.layers.BatchNormalization()(out3)
    out3 = keras.layers.UpSampling2D(2)(out3)
    out3 = keras.layers.Conv2D(256, 2, 2, "same")(out3)
    #out3 = keras.layers.BatchNormalization()(out3)
    out3 = keras.layers.UpSampling2D(2)(out3)
    out3 = keras.layers.Conv2D(128, 2, 2, "same")(out3)
    out3 = keras.layers.BatchNormalization()(out3)
   
    out1 = keras.layers.Conv2D(128, 3, 2, "same")(out1)
    out2 = keras.layers.Conv2D(128, 3, 2, "same")(out2)
    out3 = keras.layers.Conv2D(128, 3, 2, "same")(out3)
