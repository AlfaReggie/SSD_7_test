...
def fpn(out1, out2, out3):
    ...
    out1 = keras.layers.MaxPooling2D()(out1)
    out1 = keras.layers.Conv2D(512, 2, 2, "same")(out1)
    out1 = keras.layers.BatchNormalization()(out1)
    ...
    out2 = keras.layers.MaxPooling2D()(out2)
    out2 = keras.layers.Conv2D(512, 2, 2, "same")(out2)
    out2 = keras.layers.BatchNormalization()(out2)
    ...
    out1 = keras.layers.Conv2D(1024, 4, 3, "same")(out1)
    out2 = keras.layers.Conv2D(1024, 4, 3, "same")(out2)
    out3 = keras.layers.Conv2D(1024, 4, 3, "same")(out3)
